...
export function EfficiencySplitCard({ snapshots }: Props) {
  ...
  return (
    <div className="bg-white border border-border-subtle rounded-[10px] p-4 hover:border-border-card transition-colors duration-150">
      <div className="font-mono text-[8px] tracking-[.1em] uppercase text-ink3 mb-[5px]">Efficiency split</div>

      <div className="flex gap-1.5 mb-2">
        <span className="font-mono text-[8px] px-[7px] py-[3px] rounded bg-success-bg text-success">Good {pHi}%</span>
        <span className="font-mono text-[8px] px-[7px] py-[3px] rounded bg-warning-bg text-warning">OK {pMid}%</span>
        <span className="font-mono text-[8px] px-[7px] py-[3px] rounded bg-danger-bg text-danger">Low {pLo}%</span>
      </div>

      <div className="h-1.5 bg-bg-elevated rounded flex overflow-hidden gap-0.5 mb-1.5">
      ...
      <div className="font-mono text-[8px] text-ink3 leading-[1.6]">
