...
public class HeatPumpAggregationService
{
    public static List<DailyAggregateDto> ComputeDailyAggregates(List<HeatPumpSnapshot> snapshots)
    {
        return snapshots
            ...
            .Select(g =>
            {
                ...
                return new DailyAggregateDto
                {
                    ...
                    HotWaterTotalMinutes = hwTotalSnapshots * Constants.SnapshotIntervalMinutes,
    ...
    public static double? AvgDecimal(List<HeatPumpSnapshot> snapshots, Func<HeatPumpSnapshot, decimal?> selector)
    {
    ...
    /// </summary>
    public static void EnrichAggregatesWithTimeSeries(
        ...
        List<HeatPumpSnapshot> snapshots)
    {
        ...
        foreach (var (date, records) in tsByDate)
        {
            ...
            {
                var nearest = FindNearestSnapshot(snapshotsByTime, rec.StartAt, TimeSpan.FromMinutes(Constants.NearestSnapshotWindowMinutes));
    ...
    /// </summary>
    public static HeatPumpSnapshot? FindNearestSnapshot(List<HeatPumpSnapshot> sortedSnapshots, DateTime target, TimeSpan maxDistance)
    {
